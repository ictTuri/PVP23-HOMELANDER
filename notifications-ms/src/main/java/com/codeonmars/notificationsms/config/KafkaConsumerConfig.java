...
public class KafkaConsumerConfig  {
    ...
    @Bean
    public ConsumerFactory<String, NotificationRecord> consumerConfig() {
        JsonDeserializer<NotificationRecord> deserializer = new JsonDeserializer<>(NotificationRecord.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, NotificationRecord> kafkaListenerContainerFactory(){
